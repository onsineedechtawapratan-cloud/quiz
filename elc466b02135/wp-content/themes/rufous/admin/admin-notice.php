...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'                          => rufous_theme()->getPluginsManager()->getPluginState( rufous_get_builder_plugin_slug() ),
			'install_url'                     => rufous_theme()->getPluginsManager()->getInstallLink( rufous_get_builder_plugin_slug() ),
			'activate_url'                    => rufous_theme()->getPluginsManager()->getActivationLink( rufous_get_builder_plugin_slug() ),
			'slug'                            => rufous_get_builder_plugin_slug(),
...
<div class="rufous-notice-dont-show-container">
	<button class="button-link rufous-dont-show-notice">
		<?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
	</button>
</div>

<div class="rufous-admin-notice-spacer">
	<div class="rufous-admin-big-notice--container">
		<div class="content-holder">
			<div class="messages-area">
				<div class="title-holder">
					<h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', rufous_theme()->getName() ); ?></h1>
					<p><?php Translations::escHtmlE( 'theme_description', rufous_theme()->getName() ); ?></p>
				</div>

				<ul>
					<li>
						<img src="<?php echo rufous_theme()->getListMarkerUrl(); ?>" alt="">
			...
			<div class="front-page-preview">
				<img src="<?php echo esc_url( rufous_theme()->getFrontPagePreview() ); ?>"/>
			</div>
		</div>
	</div>
</div>
